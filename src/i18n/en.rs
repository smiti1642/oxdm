pub fn get(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "ptz_status" => "Position",
        "ptz_status_moving" => "moving",
        "ptz_absolute" => "Go to position",
        "ptz_absolute_go" => "Go",
        ...
        "tab_health" => "Health",
        "tab_quirks" => "Quirks",
        "quirk_summary" => "{device}: {quirks} of {compared} operations differ in shape from oxvif's reference response (not ONVIF-schema conformance).",
        "quirk_clean" => "No structural drift — every recorded response matches oxvif's reference shape.",
        ...
        "quirk_save_baseline" => "Save as baseline",
        ...
        "quirk_diff_resolved" => "no longer drifting",
        "quirk_diff_changed" => "drift changed shape",
        ...
        "quirk_parse_declined" => "declined",
        "quirk_parse_declined_head" => "The device declined {n} operation(s) with a SOAP Fault — correct device behaviour, not an oxvif problem",
        "quirk_show_clean" => "Show clean operations",
        "quirk_group_other" => "Other",
        "quirk_group_stats" => "{issues} issues · {clean} clean · {skipped} skipped",
        "quirk_group_all_clean" => "Nothing wrong in this group. Tick \"Show clean operations\" to see every row.",
        // ── Quirks: live camera test ────────────────────────────────────────
        "quirk_live_run" => "Test this camera",
        "quirk_live_running" => "Testing…",
        "quirk_live_retest" => "Test again",
        "quirk_live_done" => "Camera test complete",
        "quirk_live_failed" => "Camera test failed",
        "quirk_live_count" => "{n} operations will run ({picked} picked + {auto} prerequisites)",
        "quirk_live_readonly" => "Read-only: the sweep issues ONVIF Get* commands only. It cannot change any camera setting.",
        "quirk_sel_group_toggle" => "Select or clear this whole group",
        "quirk_sel_auto" => "auto",
        "quirk_sel_auto_n" => "+{n} auto",
        "quirk_sel_auto_title" => "Included automatically — needed by {ops}",
        "quirk_sel_requires" => "Needs {op} ({group}) first",
        "quirk_phase_step" => "Step {step} of 4 · {phase}",
        "quirk_phase_connecting" => "Connecting",
        "quirk_phase_sweep" => "Reading the camera",
        "quirk_phase_verifying" => "Verifying with oxvif's parser",
        "quirk_phase_diffing" => "Diffing against the reference",
        "quirk_out_failed" => "failed",
        "quirk_out_failed_note" => "the device errored on every attempt",
        "quirk_out_nodata" => "not present",
        "quirk_out_nodata_note" => "the list read succeeded but was empty — this camera has no such path",
        "quirk_out_prereq" => "unreachable",
        "quirk_out_prereq_note" => "its token source failed, so this could not be reached",
    ...
    "ptz_presets_no_match" => "No presets match.",
        ...
        "hbatch_title" => "Health Overview",
        "hbatch_subtitle" => "Batch ONVIF conformance test across devices — export the results to report brand-specific quirks.",
        "hbatch_select_all" => "Select all",
        ...
        "hbatch_gprobe_replay_ok" => "replay URI OK",
        "hbatch_sprobe" => "Stream probe:",
        "hbatch_sprobe_snapshot" => "snapshot",
        "hbatch_sprobe_rtsp" => "RTSP",
        "hbatch_sprobe_rtsp_ok" => "RTSP OK",
        "hbatch_declared" => "Declared:",
        "hbatch_declared_broken" => "declared, failing",
        "hbatch_details" => "Details",
        "hbatch_detail_title" => "Health check detail",
        "health_declared_profiles" => "Declared profiles",
        "hbatch_exported" => "Report exported",
        "hbatch_export_failed" => "Export failed",
        "hbatch_export_nothing" => "Nothing to export yet — run a check first.",
        ...
        "hgroups_new_group_placeholder" => "New group name…",
        "hgroups_create" => "Create",
        ...
        "hgroups_source_label" => "Source",
        "hgroups_auth_label" => "Auth",
        "hgroups_offline" => "offline",
        "hgroups_cred_device" => "cred: device",
        "hgroups_cred_group" => "cred: group",
        "hgroups_cred_app" => "cred: app",
